...
TEST(Map, actionTest) {
  ...
  EXPECT_EQ(make_pair(6, 5), mapTestObject->action(1, currentNode));
  EXPECT_EQ(make_pair(5, 6), mapTestObject->action(2, currentNode));
  EXPECT_EQ(make_pair(4, 5), mapTestObject->action(3, currentNode));
  EXPECT_EQ(make_pair(5, 4), mapTestObject->action(4, currentNode));
}
